          ...
          <div key={idx}>
            <div
              className={classnames({
                [styles.selected]: step.codeError!.fromRowNumber + idx === step.codeError!.row,
              })}
            >
              <span className={styles.cursors}>
                {step.codeError!.fromRowNumber + idx === step.codeError!.row ? '> ' : '  '}
              </span>
            ...
            {step.codeError!.fromRowNumber + idx === step.codeError!.row && (
              <div className={styles.cursors}>{'\u00A0'.repeat(step.codeError!.column + identation - 1)}^</div>
            )}
          </div>
        ))}
      </div>
